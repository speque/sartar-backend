...
(def questions
  ...
  {:title "7. Marriage of Orlanth and Ernalda "
     ...
     :options [{:title "Air" :rune :air :modifiers {}}
               {:title "Earth" :rune :earth :modifiers {}}
   ...
   {:title "8. The Vingkotling Age"
    ...
    {:title "8. The Vingkotling Age"
     ...
     :options [
       {:title "We made them slaves, and called them thralls." :modifiers {}}
       {:title "We made them sheepherders, and called them cottars." :modifiers {}}
       {:title "We gave them equal rights as free men. " :modifiers {}}
     ]}
   ...
   {:title "10. The Great Darkness"
    ...
    {:title "11. The Chaos Wars"
     ...
     {:title "12. The Die Off"
      ...
      :options [
        {:title "The elves, who taught you to call them Aldryami." :modifiers {} :disabled_by [9 3]}
        {:title "The Mostali, whom you had previously called dwarves." :modifiers {} :disabled_by [9 2]}
        {:title "The trolls, who now wanted you to call them Uz." :modifiers {} :disabled_by [9 9]}
        {:title "The nomads of Prax, who had always raided our lands, but who shared common deities and hatred of Chaos." :modifiers {} :disabled_by [9 6]}
        {:title "The dragonewts, who served the monstrous dragons in their unfathomable and alien ways, but feared Chaos as did you." :modifiers {} :disabled_by [9 1]}
      ]}
     ...
     {:title "16. The Era of Time"
      ...
      :options [
        {:title "Our ancestors, we did not need more." :modifiers {} :explanation "None."}
      ...
      {:title "17. Lokamayadon"
       ...
       {:title "21. The Third Age"
        ...
        :options [
          {:title "We hated the God-King." :modifiers {}}
        ...
        {:title "21. The Third Age"
         ...
         :options [
           {:title "Hills and Highlands, good for herding sheep and defending against foes." :modifiers {}}
        ...
        {:title "22. New Enemies"
         ...
         :tag :new-enemy
         :options [
          {:title "The Aldryami, who fought you when you cut down their woods." :modifiers {}}
        ...
        {:title "23. The New Tribes"
         ...
         :options [
           {:title "Aranwyth, the Cloud Tribe" :modifiers {}}
        ...
        {:title "24. King Sartar"
         ...
         :options [
           {:title "He performed many miracles, and never lifted weapons against his foes." :modifiers {}}
        ...
        {:title "25. The Lunar War"
         ...
         "
         :options [
           {:title "We killed them." :modifiers {}}
        ...
        {:title "26. Tarkalor's War"
         ...
         :options [
           {:title "We gave no quarter, and expected none." :modifiers {}}
        ...
        {:title "27. Defeat and Occupation"
         ...
         :options [
           {:title "Many of our people abandoned their land and took to the hills as rebels." :modifiers {}}
         ...
         {:title "28. Infighting"
          ...
          :options [
            {:title "Our chieftain settled disputes, giving away cattle when necessary. We earned the respect of the other clans and tribes, but at great cost." :modifiers {}}
          ...
          {:title "29. Starbrow's Rebellion"
           ...
           :options [
             {:title "We sent all our warriors to fight." :modifiers {}}
           ...
           :options [
             {:title "We hate him, but there is nothing to be done." :modifiers {}}
